#!/usr/bin/env python3
"""Dawn fetch cycle 20260719_182000 (02:20 MYT 20 Jul 2026).
11th carry-forward of 14:50 Director-approved cycle (mission brief: 4th carry-forward).
Day-2 dawn window. Malaysian news cycle dormant (post-midnight MYT), but late-night
  dispatches from Day-1 close + any 20-Jul pre-dawn items may surface.
Sources: FMT RSS + NST WP feed + BH WP feed + Utusan WP feed + TRP feed + Harian Metro /feed
       (all content:encoded) + Awani direct berita-politik (URL-path dedup fix maintained)
       + mkini direct 780351-780400
       + gnews 20 queries incl. mandatory kuorum + lebih-hebat (PIR-06 [CRITICAL] watch)
gnews-overwrite-RSS FIX maintained (checks file existence, uses _gnews/_rss suffix).
Cutoff: post-01:15 MYT 20 Jul 2026 (post-17:15 UTC 19 Jul). TLP:AMBER. All content carries source URL.
"""
...
THIS_TS = "20260719_182000"
PRIOR_TS = "20260719_171500"
TODAY = "20260719"
TS_TIME = "182000"
CUTOFF_UTC = datetime.datetime(2026, 7, 19, 17, 15, 0, tzinfo=datetime.timezone.utc)
CUTOFF_MYT = "01:15"
...
def is_fresh(pubdate_str):
    """Check if pubdate >= 01:15 MYT 20 Jul 2026 (17:15 UTC 19 Jul). Handle MYT-as-GMT bug."""
...
# ============================================================
# PART C4: Harian Metro /feed (NEW PERMANENT SOURCE — confirmed working prior cycle)
# ============================================================
print("\n" + "="*70)
print("=== PART C4: Harian Metro /feed (NEW PERMANENT SOURCE) ===")
...
# ============================================================
# PART C5: NEW source tests — Sinar alternate paths + mStar + Bernama (retry)
# ============================================================
print("\n" + "="*70)
print("=== PART C5: NEW source tests (Sinar/mStar/Bernama alternate paths) ===")
NEW_FEED_TESTS = [
    ("SINAR_INDEX", "https://sinarharian.com.my/index.php/feed"),
    ("SINAR_RSS",    "https://rss.sinarharian.com.my"),
    ("SINAR_CAT",    "https://sinarharian.com.my/category/politik/feed"),
    ("MSTAR_RSS",    "https://www.mstar.com.my/rss"),
    ("MSTAR_FEED2",  "https://www.mstar.com.my/feed/rss"),
    ("BERNAMA_NEWS", "https://rss.bernama.com/rss/news.php"),
    ("BERNAMA_EN",   "https://www.bernama.com/services/rss/en/news"),
    ("BERNAMA_BM",   "https://www.bernama.com/services/rss/bm/news"),
]
...
# ============================================================
# PART E: mkini direct 780351-780400
# ============================================================
print("\n" + "="*70)
print("=== PART E: mkini direct 780351-780400 ===")
mkini_count = 0
for nid in range(780351, 780401):
    ...
    mkini_count += 1
print(f"mkini: {mkini_count} genuinely-new NS-relevant articles in 780351-780400")
...
GNEWS_QUERIES = [
    # Mandatory PIR-06 [CRITICAL] watch
    ...
    # NEW this cycle — Day-2 dawn watch
