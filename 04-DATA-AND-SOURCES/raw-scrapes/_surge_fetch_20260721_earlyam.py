#!/usr/bin/env python3
"""Nomination-Day Surge cycle 20260721_earlyam (collecting ~17:58 UTC / 01:58 MYT 21 Jul 2026).
Campaign Day 3 (MYT 21 Jul). Director-approved PIR-06/07/16 priority collection.
Cutoff: post-16:54 UTC 20 Jul 2026 (post-00:54 MYT 21 Jul) = dawn cycle end.

FOCUS: Early-morning scan ~1hr after dawn cycle. Check for:
  - Any fresh Day-3 (21 Jul) campaign ground content posted after 00:50 MYT
  - PIR-06 [CRITICAL] watch (31st cycle): formal PN-MT expulsion, Bersatu withdrawal,
  ...
  - Manifesto reception / BN-PN counter-response pickup
...
THIS_TS = "20260721_earlyam"
TODAY = "20260721"
# Cutoff = dawn cycle end (16:54 UTC 20 Jul = 00:54 MYT 21 Jul)
CUTOFF_UTC = datetime.datetime(2026, 7, 20, 16, 54, 0, tzinfo=datetime.timezone.utc)
...
print(f"[0] cutoff: {CUTOFF_UTC.isoformat()} (00:54 MYT 21 Jul) | now: {NOW_UTC.isoformat()}")
...
print("\n=== [1] GOOGLE NEWS RSS ===")
GNEWS_QUERIES = [
    # PIR-06 [CRITICAL] watch (mandatory — 31st cycle)
...
# SAVE summaries
# ============================================================
with open(f"{BASE}/_gnews_headlines_20260721_earlyam.json","w") as f:
    json.dump(results['gnews_headlines'], f, ensure_ascii=False, indent=1)
with open(f"{BASE}/_earlyam_summary_20260721.json","w") as f:
    json.dump(results, f, ensure_ascii=False, indent=1, default=str)

print("\n" + "=" * 60)
print(f"EARLYAM CYCLE SUMMARY ({THIS_TS})")
