#!/usr/bin/env python3
"""Nomination-Day Surge cycle 20260720_night2 (collecting ~13:59 UTC / 21:59 MYT 20 Jul 2026).
Campaign Day 2-3 (MYT 20 Jul). Director-approved PIR-06/07/16 priority collection.
Cutoff: post-12:46 UTC 20 Jul 2026 (post-20:46 MYT 20 Jul) = prior postmanifesto cycle end.
HIGHEST PRIORITY: PH MANIFESTO LAUNCH coverage (event completed ~20:00 MYT; coverage now ~1h+ old,
  should be fully propagating across RSS/gnews/homepages). Capture full manifesto pledges,
  Amirudin Shari speech, Aminuddin framing, PH 36-seat strategy, B40/M50 expansion,
  "kesinambungan" continuity messaging. This is the 4th consecutive cycle flagging manifesto launch.
ALSO HIGH PRIORITY (PIR-16): Track Loke "I will abide by DAP congress decision" pickup across
  other outlets (NST, Star, Awani, Sinar) + any AMK/Amanah/UMNO/Bersatu responses.
Sources: Awani RSS (full) + FMT RSS (full content:encoded) + HarianMetro RSS (full)
       ...
       + targeted Sinar article-ID scan (788800-788880) to recover fresh content.
...
THIS_TS = "20260720_night2"
TODAY = "20260720"
# Cutoff = prior postmanifesto cycle end (12:46 UTC 20 Jul = 20:46 MYT 20 Jul)
CUTOFF_UTC = datetime.datetime(2026, 7, 20, 12, 46, 0, tzinfo=datetime.timezone.utc)
...
PIR16 = ['narrative','dap acceptance','loke','mca biggest loser','mca rebuttal','wee','mah hang soon',
         ...
         'bersatu sasar bentuk kerjaan negeri']
    ...
    if os.path.isdir(p):
        for fn in os.listdir(p):
            if fn.endswith('.md'):
                ...
                core = re.sub(r'_(20260720_(?:morning|midday|afternoon|evening|midafternoon|lateafternoon|dusk|night|latenight|postmanifesto|night2)|20260719_[^_]*)(?:_rss|_home|_targeted)?\.md','.md', fn)
...
print(f"[0] cutoff: {CUTOFF_UTC.isoformat()} (19:36 MYT 20 Jul) | now: {NOW_UTC.isoformat()}")

# ============================================================
# 1. GOOGLE NEWS RSS — PIR-targeted queries (manifesto-focused)
# ============================================================
GNEWS_QUERIES = [
    ...
    'Asyraf Wajdi menebuk atap Kerajaan Perpaduan',
    # PIR-16 narratives
    ...
    # PIR-07 battlegrounds — MANIFESTO FOCUS (post-launch coverage)
    ...
    'manifesto PH kesinambungan kerajaan perpaduan Negeri Sembilan',
    'Aminuddin manifesto PH Negeri Sembilan',
    'Negeri Sembilan PRN 2026 manifesto BN PH',
    'PH manifesto malam Negeri Sembilan Amirudin',
    'manifesto PH Negeri Sembilan B40 M50',
    'PH Negeri Sembilan manifesto 36 kerusi',
    'manifesto kesinambungan kemakmuran PH Negeri Sembilan',
    'Aminuddin kempen beradab matang Negeri Sembilan',
    'Aminuddin Harun Linggi Sikamat manifesto',
    ...
    'Jalaluddin denies cash voters walkabout Negeri Sembilan',
    ...
    'lelaki maut pasang bendera parti Negeri Sembilan',
    'lelaki ditahan hina institusi diraja Negeri Sembilan',
    'man arrested insulting Negeri Sembilan royalty',
    # generic catch
    ...
    # post-manifesto additions — evening coverage + incident follow-up
    'manifesto PH dilancarkan Negeri Sembilan malam',
    'PH Negeri Sembilan manifestopledges perlindungan',
    'Amirudin Shari manifesto PH Negeri Sembilan speech',
    'Aminuddin Harun manifesto PH continuity Negeri Sembilan',
    'Anthony Loke manifesto PH Negeri Sembilan Chennah',
    ...
    'Negeri Sembilan calon wanita Pilah',
    'status quo dipertahankan PRN Negeri Sembilan',
    'gelanggang PRN Negeri Sembilan',
    # night2 additions — manifesto launch coverage (now propagating ~1h post-event) + Loke pickup
    ...
    'manifesto PH Negeri Sembilan kemakmuran kesinambungan',
    'PH manifesto Negeri Sembilan promise pledges',
    'Pakatan Harapan manifesto launch Negeri Sembilan',
    'Amirudin manifesto PH Negeri Sembilan speech',
    'Aminuddin Harun PH manifesto continuity Negeri Sembilan',
    'manifesto PH Negeri Sembilan dewan',
    'manifesto PH Negeri Sembilan seremban',
    'manifesto PH Negeri Sembilan paroi',
    'manifesto PH Negeri Sembilan lobak',
    'manifesto PH Negeri Sembilan ampangan sikamat',
    # Loke DAP-congress pickup tracking (PIR-16 HIGH PRIORITY)
    'Loke DAP congress Unity Government Negeri Sembilan',
    'Anthony Loke DAP kongres kerajaan perpaduan',
    'Loke abide DAP congress decision',
    'Loke DAP keluar kerajaan perpaduan PRN',
    'DAP congress August Negeri Sembilan PRN',
    'Loke taat keputusan kongres DAP',
    'DAP tinggalkan kerajaan perpaduan PRN Negeri Sembilan',
    # Day-2 night campaign
    'PRN Negeri Sembilan ceramah malam 21 Jul',
    'Negeri Sembilan kempen malam calon 21 Jul',
    'Negeri Sembilan PRN walkabout 21 Jul',
    'Tok Mat Rantau ceramah malam 21 Jul',
    'Aminuddin Harun ceramah malam Negeri Sembilan',
    'BN manifesto Linggi Pertang 24 Jul advance',
    # BN manifesto advance coverage
    'BN manifesto Negeri Sembilan 24 Jul',
    'Tok Mat BN manifesto launch Negeri Sembilan',
    'UMNO BN manifesto Negeri Sembilan',
]
...
url_prn_kw = ['negeri-sembilan','prn','bersatu','loke','tok-mat','aminuddin','sikamat','ampangan',
              ...
              'kwap','efishery','fathi-aris','rafizi','bersama','asas','kesinambungan',
              'asyraf','menebuk','button-badge','diraja','bendera','maut','status-quo','gelanggang']
home_extracted = 0
for full in list(home_links):
    ...
    fn_info = save_article('Awani' if 'awani' in full else
                           ('Utusan' if 'utusan' in full else
...
# ============================================================
# 6. Targeted Sinar article-ID scan (788880-788960) for fresh content
# ============================================================
sinar_saved = 0
sinar_new = []
for aid in range(788880, 788961):
...
print(f"[6] Sinar targeted scan 788880-788960: {sinar_saved} saved, {len(sinar_new)} PRN hits found")

# ============================================================
# SAVE gnews headlines JSON + summary
# ============================================================
with open(f"{BASE}/_gnews_headlines_20260720_night2.json","w") as f:
    json.dump(results['gnews_headlines'], f, ensure_ascii=False, indent=1)

results['sinar_targeted_hits'] = sinar_new
with open(f"{BASE}/_night2_summary_20260720.json","w") as f:
    json.dump(results, f, ensure_ascii=False, indent=1, default=str)

print("=" * 60)
print(f"NIGHT2 CYCLE SUMMARY ({THIS_TS})")
...
for sf in results['saved_files']:
    print(f"  - {sf}")
print("SINAR TARGETED HITS (788800-788880):")
for s in sinar_new:
