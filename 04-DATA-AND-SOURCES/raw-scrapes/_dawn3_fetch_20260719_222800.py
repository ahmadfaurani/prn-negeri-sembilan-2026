#!/usr/bin/env python3
"""Dawn-3 fetch cycle 20260719_222800 (06:28 MYT 20 Jul 2026 / 22:28 UTC 19 Jul 2026).
14th carry-forward of 14:50 Director-approved cycle (mission brief: 4th carry-forward).
Day-2 early-morning window. Malaysian news cycle dormant (pre-dawn/early MYT); low yield expected.
Verifying whether any genuinely-new content surfaced since prior 212300 cycle (05:23 MYT 20 Jul).
Sources: FMT RSS + NST WP + BH WP + Utusan WP + TRP feed + Harian Metro /feed
       ...
       + mkini direct 780511-780570
       + gnews 28 queries incl. mandatory 8 PIR-06 [CRITICAL]-watch (kuorum + lebih-hebat etc.)
gnews-overwrite-RSS FIX maintained (checks file existence, uses _gnews/_rss suffix).
Cutoff: post-21:23 UTC 19 Jul (post-05:23 MYT 20 Jul) = prior cycle end.
...
THIS_TS = "20260719_222800"
TODAY = "20260719"
TS_TIME = "222800"
# Prior cycle (212300) ran at 21:23 UTC 19 Jul = 05:23 MYT 20 Jul. Use that as cutoff.
CUTOFF_UTC = datetime.datetime(2026, 7, 19, 21, 23, 0, tzinfo=datetime.timezone.utc)
CUTOFF_MYT = "05:23"
...
def is_fresh(pubdate_str):
    """Check if pubdate >= 05:23 MYT 20 Jul 2026 (21:23 UTC 19 Jul). Handle MYT-as-GMT bug."""
...
# ============================================================
# PART E: mkini direct 780511-780570
# ============================================================
print("\n" + "="*70)
print("=== PART E: mkini direct 780511-780570 ===")
mkini_count = 0
for nid in range(780511, 780571):
    ...
    mkini_count += 1
print(f"mkini: {mkini_count} genuinely-new NS-relevant articles in 780511-780570")
...
GNEWS_QUERIES = [
    # Mandatory PIR-06 [CRITICAL] watch (8)
