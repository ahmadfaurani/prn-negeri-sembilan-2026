#!/usr/bin/env python3
"""Overnight fetch cycle 20260719_171500 (01:15 MYT 20 Jul 2026).
10th carry-forward of 14:50 Director-approved cycle (mission brief: 4th carry-forward).
Nomination-Day +1 closing / Day-2 dawn window. Malaysian news cycle dormant (post-midnight MYT).
Sources: FMT RSS + NST WP feed + BH WP feed + Utusan WP feed + TRP feed (all content:encoded)
       + Awani direct berita-politik (URL-path dedup fix maintained)
       + mkini direct 780311-780350
       + NEW source tests: Bernama alternate paths, Sinar alternate paths, mStar alternate paths
...
Cutoff: post-23:33 MYT 19 Jul (post-15:33 UTC). TLP:AMBER. All content carries source URL.
"""
...
THIS_TS = "20260719_171500"
PRIOR_TS = "20260719_153300"
TODAY = "20260719"
TS_TIME = "171500"
CUTOFF_UTC = datetime.datetime(2026, 7, 19, 15, 33, 0, tzinfo=datetime.timezone.utc)
CUTOFF_MYT = "23:33"
...
def is_fresh(pubdate_str):
    """Check if pubdate >= 23:33 MYT 19 Jul 2026 (15:33 UTC). Handle MYT-as-GMT bug."""
...
# ============================================================
# PART C3: TRP (The Rakyat Post) WordPress feed — confirmed working prior cycle
# ============================================================
print("\n" + "="*70)
...
# ============================================================
# PART C4: NEW source tests — alternate Bernama/Sinar/mStar paths
# ============================================================
print("\n" + "="*70)
print("=== PART C4: NEW source tests (alternate Bernama/Sinar/mStar paths) ===")
NEW_FEED_TESTS = [
    ...
    ("METRO",        "https://www.hmetro.com.my/feed"),
    ("METRO_RSS",    "https://www.hmetro.com.my/rss"),
]
...
# ============================================================
# PART E: mkini direct 780311-780350
# ============================================================
print("\n" + "="*70)
print("=== PART E: mkini direct 780311-780350 ===")
mkini_count = 0
for nid in range(780311, 780351):
    ...
    mkini_count += 1
print(f"mkini: {mkini_count} genuinely-new NS-relevant articles in 780311-780350")
