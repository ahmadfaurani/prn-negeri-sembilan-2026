#!/usr/bin/env python3
"""Dawn-2 fetch cycle 20260719_212300 (05:23 MYT 20 Jul 2026 / 21:23 UTC 19 Jul 2026).
13th carry-forward of 14:50 Director-approved cycle (mission brief: 4th carry-forward).
Day-2 dawn window. Malaysian news cycle dormant (pre-dawn MYT); low yield expected.
Verifying whether any genuinely-new content surfaced since prior 200000 cycle.
...
Cutoff: post-20:00 UTC 19 Jul (post-04:00 MYT 20 Jul) = prior cycle end.
...
THIS_TS = "20260719_212300"
TODAY = "20260719"
TS_TIME = "212300"
# Prior cycle (200000) ran at 20:00 UTC 19 Jul = 04:00 MYT 20 Jul. Use that as cutoff.
CUTOFF_UTC = datetime.datetime(2026, 7, 19, 20, 0, 0, tzinfo=datetime.timezone.utc)
CUTOFF_MYT = "04:00"
...
def is_fresh(pubdate_str):
    """Check if pubdate >= 04:00 MYT 20 Jul 2026 (20:00 UTC 19 Jul). Handle MYT-as-GMT bug."""
...
# ============================================================
# PART E: mkini direct 780451-780510
# ============================================================
print("\n" + "="*70)
print("=== PART E: mkini direct 780451-780510 ===")
mkini_count = 0
for nid in range(780451, 780511):
    ...
    mkini_count += 1
print(f"mkini: {mkini_count} genuinely-new NS-relevant articles in 780451-780510")
