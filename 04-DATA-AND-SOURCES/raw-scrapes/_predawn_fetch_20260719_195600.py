#!/usr/bin/env python3
"""Pre-dawn fetch cycle 20260719_195600 (03:56 MYT 20 Jul 2026 / 19:56 UTC 19 Jul 2026).
12th carry-forward of 14:50 Director-approved cycle (mission brief: 4th carry-forward).
Day-2 pre-dawn window. Malaysian news cycle dormant (post-midnight MYT); low yield
  expected. Verifying whether any genuinely-new content surfaced since prior 182000 cycle.
Sources: FMT RSS + NST WP + BH WP + Utusan WP + TRP feed + Harian Metro /feed
       ...
       + mkini direct 780401-780450
       + gnews 23 queries incl. mandatory kuorum + lebih-hebat (PIR-06 [CRITICAL] watch)
gnews-overwrite-RSS FIX maintained (checks file existence, uses _gnews/_rss suffix).
Cutoff: post-18:33 MYT-aligned UTC 19 Jul (post-02:33 MYT 20 Jul) = prior cycle end.
...
THIS_TS = "20260719_200000"
TODAY = "20260719"
TS_TIME = "200000"
# Prior cycle (182000) ran at 18:33 UTC 19 Jul = 02:33 MYT 20 Jul. Use that as cutoff.
CUTOFF_UTC = datetime.datetime(2026, 7, 19, 18, 33, 0, tzinfo=datetime.timezone.utc)
CUTOFF_MYT = "02:33"
...
def is_fresh(pubdate_str):
    """Check if pubdate >= 02:33 MYT 20 Jul 2026 (18:33 UTC 19 Jul). Handle MYT-as-GMT bug."""
...
# ============================================================
# PART E: mkini direct 780401-780450
# ============================================================
print("\n" + "="*70)
print("=== PART E: mkini direct 780401-780450 ===")
mkini_count = 0
for nid in range(780401, 780451):
    ...
    mkini_count += 1
print(f"mkini: {mkini_count} genuinely-new NS-relevant articles in 780401-780450")
